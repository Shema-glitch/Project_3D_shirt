...
const Customizer = () => {
  ...
  const handleSubmit = async (type) => {
    ...
    try {
        ...
        console.log('Response:', response); // Add this line to check the response object
        console.log('Data:', data); // Add this line to check the data object
  ...
  const handleActiveFilterTab = (tabName) => {
    ...
    // update the state of the filtertab
